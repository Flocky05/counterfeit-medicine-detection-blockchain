...
const Manufacturer = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // Perform the necessary actions to add the product to the database or state
    console.log(product);
    ...
    return (
      <div data-aos="zoom-in" data-aos-duration="1000" className="w-2/5 mx-auto border p-5 my-20">
      <form onSubmit={handleSubmit} className=" shadow-md rounded px-8 pt-6 pb-8 mb-4">
        <div className="mb-4">
          <label className="block text-yellow-500 text-sm font-bold mb-2" htmlFor="manufacturer">
            Manufacturer
          </label>
          <input
        ...
        <div className="mb-4">
          <label className="block text-yellow-500 text-sm font-bold mb-2" htmlFor="price">
            Price
          </label>
          <input
            className="shadow appearance-none border rounded w-full py-2 px-3 text-yellow-500 leading-tight focus:outline-none focus:shadow-outline"
